...
import challenges.chapter01.Challenge01Impl_NoDataStructures;

/**
 * @author Alexandre Lorenzatti
 * 
 */
public class Challenge01Test_NoDataStructures {

	private Challenge01 challenge;
	
	@BeforeEach
	public void before() {
		this.challenge = new Challenge01Impl_NoDataStructures();
	}
